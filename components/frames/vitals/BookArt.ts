// Spell Save DC — an open book. Two page spreads meeting at a spine dip
// top-centre and bottom-centre; both page edges bow upward, the bottom
// edge parallel to the top. Drawn on the same 57.6 × 55.08 canvas as the
// heart, with matching top and bottom extremes (2.4 / 52.5) and a
